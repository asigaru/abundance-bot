...
Please read this post completely - it contains all the guidelines of our journey.

This structure is 21 days and today is the initiation day!

✨ Day 0 - The creation of the group and intentions. ✨

Guidelines:

1. After the publication of the daily task, you have around 24 hours to complete it - make sure to have it done before bedtime.

2. When in the task you need to write something, the recommendation is to actually write by hand, with a pen on paper. It is ideal to have a separate notebook specifically for the 21 Days of Abundance.

3. Before you write, come to a calm state using slow deep breathing or meditation. The best time to complete the task is right after doing Deepak Chopra’s daily meditation.

4. Please send questions in private WhatsApp message to me 😊 No need to leave “thanks” or other comments apart from those instructed in the group chat.

5. Be fully focused on the daily task, allocate time and space for it.

6. If you cannot participate, or keep the rhythm of the program, please remove yourself from the group. Make this decision on your own. It is important for us to maintain the flow so that the energy input into this process does not dissipate.

7. After completing the daily task, please write the completion statement. For example, “Day 1 Done” etc. as a confirmation for all in the group. There will be days in which I will ask you to leave other comments. Feel free to include a message about what's opened up for you. Please do so in the same message so not to flood the chat with numerous messages that become a distraction.

8. If the task is not completed within the day (24 hours), please leave the group.

This is Deepak Chopra's program. I am only a conductor of information and intentions. 
The tasks are shared exactly as provided by the program.

Ultimately, the goal is to get to know yourself better, transform and clarify beliefs and attitudes.

Every day there will be a different task with a sentence to focus on for the day, and an audio file with an explanation and a Deepak Chopra meditation. 💗

REMINDERS:

If you have questions, please do not write them here, but send to me in a personal message.

This group is only for meditations, tasks and group energy concentration. Just in case, I recommend turning off notifications from this group.

Additionally this process can be  an opportunity to learn how to allocate time for yourself and your development every day. 
...
I recommend writing the phrase in your notebook and return to it several times, the more the better.  
  
Mahatma Gandhi taught us that  our thoughts generate words, words generate actions, actions generate habits, habits generate character, and character breeds destiny.

If you have read and understood all the rules and agree to follow them, please write in the comment "Day 0 Done." This will be a test of the fact that we are on the same wavelength.
...
I invite you to keep an open mind through this process  and structure as we go along. 😊

REMINDER: Please send any questions in a private message to me, not to this group. 

After you complete the task, please write: "Day 1 Done". 

No more writing is necessary or required.

You can leave the group if you decide not to continue at your discretion.

It is suggested that you have 24 hours to complete the task. 

Day 1 will be due by midnight Monday or within 24 hours from receiving this as we are in different time zones. 

I highly recommend doing the meditation and the task at the beginning of the day, if possible. It can have a profound effect on  the course of the day!
...
It is also recommend putting the phone in airplane mode at this time so that no one will interfere with you (children and everyone around you too, as much as it is realistic for you of course). 
...
This is the Mantra you will repeat mentally during the meditation:
...
Be aware of this and STICK with it! Choose to continue and get the highest benefit of  the exercise for yourself.
...
And after that, make a list of all your monthly payments. Again without numbers, just listing.

For example: renting an apartment, electricity, gas, council tax, water, an accountant, a kindergarten, a music tutor, a gym, a manicure, insurance, gasoline, etc.
...
Write the phrase of the day in your notebook:
...
I hope this group and the daily exercises are inspiring and you are already seeing results! 

As you go through this process, keep your mind open and notice what's happening, co-incidences, new thoughts, insights, a different way of looking at a (stressful / annoying / irritating) situation. 

Please do feel free to message me directly with your experiences if you like, I'd love to hear it. 😊

Task

Draw notes, checks, stocks, bonds, coins and any other means of payment in your  notebook.

Draw enough to pay off all the debts and expenses you wrote down yesterday.  😉

Now you have complete freedom to create and draw a solution too if you're inclined. We draw in order to make it possible to pay for everything we need in the universe!
...
Remember, this is not about a drawing competition or lesson, but about allowing yourself to create your reality and let it manifest into your life.

While you are busy designing and even colouring, feel the satisfaction of creating a balance between debts and expenses and the means of payment that you create - as if it were a real payment of your expenses and debts.
...
Remember that you will have 24 hours to complete the task. Please remember the guidelines shared in Day 0 and those of you unable to complete the tasks in a timely fashion please remove yourself from the group. This is a programme of abundance that we are building both for ourselves individually, and as a group and we need to keep the momentum. To support the structure, I will be removing participants who have not been able to maintain pace of this flow.
...
Important: We're not talking only about financial prosperity, the obligatory component is the joy, the happiness that this person is experiencing!

These can be people from the previous list. How many does not matter, even a few is enough.
...
Bonus - I encourage you to also answer the questions below in your notebook (or simply answer them yourself):
...
By doing this, you will see how the field of all possibilities is widely revealed in front v of you to help your desires and dreams manifest and come true.
...
From today, you will be responsible for your own Abundance group. Even 2-3 people is enough, even at the very least one person!

Share this bot with them.

I openly described this as a “creative challenge” which I wanted to share with other interested and like-minded folk. 

Invite people from your contact list, people you know who may benefit, and even friends you haven't heard from for a while.

Seriously, take the step and invite everyone!  Do not decide for other people whether it will be interesting to them or not.
...
Only those who are ready to follow you and change their consciousness will remain in your group.

It so happens that usually the first to drop out are likely those of your friends who have a great lack of abundance in most things. As a result, you may really want to convince them to stay, but there is no need to persuade anyone. People are free to choose as they wish, remember this.

Remember, you will need to send meditations and tasks every day and make sure that only those who perform the task remain in the group, maintain the group guidelines and the general flow.
...
Believe me, it's easy to lead your group and very inspiring! (It feels very expansive and naturally abundant 😉) 

You essentially need to copy the messages that I am sending you and check the progress of the tasks. You can at times add something from yourself if you like. 

Let the love in your hearts expand, because you can contribute to the well-being of others! 

Let me assure you, that it is normal to experience resistance, and an opportunity to ask yourself what are you making important?

The gift of this exercise is a gentle practice in simple leadership and non-attachment and letting go of what people think of you. Making a difference to those who need this on a soul level is more important. But letting them choose it or not without your judgement is important too.

Please know that it is normal to have resistance and have stuff come up, but what you make important is what really counts.

Allow yourself to complete this task and give out the energy of abundance, as it comes to you.
Even if you can lead one other person, you can experience the benefits of this exercise.

Also today there is no other written assignment, other than rewriting the phrase of the day in a notebook.
...
I recommend staying organised with your group and remaining timely. Observe the order and terms of assignments and use the original texts if you wish.

Remember that we only transmit what we have received ourselves.

If you have questions about the conduct of your group, please message me privately.
...
And I ask my parents, grandparents, and ancestors to the very origins of the family, who lived in abundance and prosperity, to inspire me.”

Write this statement 10 times in your notebook by hand.

After that record yourself reading this statement with soul, expression and a deep sense of attachment, i.e.  sincerely, on audio or video. 

Our brain learns through repetition and rehearsal. Therefore, tune in to connect with what you will write.

This task is the longest in our journey!

It's recommended that before performing - to sit comfortably, relax, inhale several times slowly and deeply through the nose and exhale as slowly through the nose.
...
This journey WILL highlight your blocks and negative programming clearly so that you can see what is stopping you from living the abundant life that you desire. 
...
For example, it can be neighbors, employees, bosses, family members...
...
Receipts can be of any type: supermarket, restaurant, personal items, fuel, health, hairdresser, entertainment, etc. 
...
Do not write only from the mind but rather feel with your heart what these flaws are. You have 24 hours ~ give or take ~ to complete this task.

*Phrase*
"Today and every day, I give what I want to receive." 

And, of course, there is a pleasant and useful meditation for you.
...
Establish a program for yourself by writing down at least two specific daily actions that can help you overcome those shortcomings and misbehaviours, reduce a deficiency, or recognise if there is a plus side to them and start using it in to your advantage. 

After that, immediately begin to fulfill the intent of your program. 

For example: If one of your shortcomings / flaws is being "ungrateful," you can establish a daily journaling of writing down all of what you are grateful for.

*Phrase*
“Today I make great choices because they are made with full awareness.“

Write the phrase of the day in a notebook and keep it in your mind, remembering and saying it as often as possible during the day.

It is a good idea to start as early as possible so that there is more opportunity to repeat the phrase of the day.

In addition, it is recommended that you listen to today's meditation a few times.
...
In today's meditation, Deepak discusses the Law of Karma, or conscious decision-making, and we discover how, by making the right choices, we can bring much more good into our lives.

When you make any choice, you may ask yourself:

"How will this choice bring more happiness and more abundance to my life and those around me?"

Having asked this question, shift your attention to your heart, and be open to the answer that may immediately become clear.
...
Also write down the answers to the following questions in your notebook.

QUESTION No.1: How do you make decisions?

QUESTION No. 2: How have your decisions affected your life?
...
Explore the following questions before beginning today's task:

•QUESTION No. 1: According to your conviction, how hard should you work to enjoy true abundance?

•QUESTION No. 2: In what areas of your life would you like to get more abundance?

•QUESTION No. 3: What changes should you make to release your desires into the space of universal consciousness - the source of all abundance?

*Task*
Please describe your Mother in your notebook.
•Positive aspects
•Limitations
•What did you learn from her?
•What aspects brought you closer together?
•What aspects separated you and created distance?

If your Mother is no longer in this world, focus on her image, join her and write what rises in your memory and feelings.

For some, this task will not be easy. If this is the case - while doing it, try to distance yourself from the personal experiences you've had with your Mother. See her as just a human, a Woman living her own life.
...
Whatever you want or need in life can be programmed in the space “computer". It has unlimited organizing power to work for you, clearly articulating the intention and planting its seeds in the field of all possibilities.
...
QUESTION No. 1: What is your highest intention in life?

QUESTION No. 2: What can you do to make this happen? 

QUESTION No. 3: How will this intention best serve you and others?
...
Symbols of abundance are often in such things as a big house, a new car or elaborate jewelry that will bring waves of excitement into your life. But this does not mean sacrificing the ocean for the sake of several transient waves.
...
QUESTION No. 1: What symbols of abundance do you dream of?

QUESTION No. 2: How could they improve both your life and others?

QUESTION No. 3: How else will such abundance positively affect your life? 

*Task*
Think about your Mother's description from Day 11.

Consider your life and your recurring patterns.

Do you see “copy-paste” situations or at least some similarities between you and your Mother?

What are they, how were they formed? 

Write these reflections in your notebook.

Listen to today's meditation, recommended a couple of times.
...
It is not only about material wealth, but also about satisfaction, confidence, optimism, joy and abundance! And all of it's manifestations that will come to you if you live your true purpose in life.
...
*Task*
Enjoy this day, noticing the generous gifts of the world that surround you, seek you, and ask you to notice and accept them. Seek, find, accept and give thanks for each of them.

At the end of the day, write down at least three paths/ sources through which abundance has come to you today. Even if it was something very small.

Also watch this short video and think about the question that follows:

https://youtu.be/VVckUjjFYlM
...
More than one person may appear, however, today we write a letter to only one.

As you sit down to write, cleanse yourself of negative emotions towards this person. If you still have resentment or anger, you can separately write down all these feelings for them on paper and then burn or tear the sheet to shreds, often just noticing them can help a great deal.
...
The idea of writing this list is to forgive yourself for everything that you have not yet done in your life.
...
•I have internet
•I have an affection for my husband or wife
•I have created beautiful memories
•I have an education
•I have a favorite city
•And so on...

There are no high or low limits to the things that you can write down. Recognize everything you have that matters to you.

*Phrase*
‎״I move through my days light-hearted and care-free knowing all is well.”
...
Throughout life, you will begin to look at everyday circumstances easily and meet surprises calmly and with grace. Answer the following in your notebook.

•Question No. 1: How do you feel when you wake up every morning?

•Question No. 2: How much would your life improve if you lived with a light and carefree heart?
...
And remember to write down today's centering thought in your notebook and keep your attention on it throughout the day. 
...
•QUESTION No. 1: How would you define unity?

•QUESTION No. 2: What do you think of diversity?
...
Moreover, today please SHARE in the group - what does story and passage mean to you? What is YOUR takeaway from it?

📜Fable - This too shall pass.

There was a king and he once said to the court sages: "I have a ring with one of the finest diamonds in the world and I want to inscript a message under the stone that can be useful in a situation of extreme despair. I will give this ring to my heirs and I want it to serve faithfully. Think of what kind of message will serve this purpose. It must be very short to fit in the ring."
...
“I’m not a sage, I’m not educated, but I know such a message. For many years spent in the palace, I met a lot of people. And once I served a visiting mystic whom your father invited. And he gave me this message. Just don’t read it, pass it to the craftsman and only open it when there is no way out at all”.
...
👑 Dear Friends, today, after completing the task, as usual, comment “Day 19 Done”, and then also look at the events in your life - both good and not so good - while considering the words of the Fable "This too shall pass."

Then write here in the group what thoughts and feelings you have about the meaning of the Fable, along with your takeaway and learning.
...
See if there is something that you missed or if you would you like to supplement anything in the light of your new awareness? 
...
Share the Fable from Day 19 with this person and write down what happens in your journal. 

How did you feel sharing the story with them? What thoughts, associations, sensations arose for you in the process? Did they answer? Did you talk about it, and of so what did you discuss?
...
•QUESTION No. 1: How is luxury manifested in your life?

•QUESTION No. 2: What luxurious gifts do you present to yourself?

•QUESTION No. 3: How can you bring luxury to others?
...
I am very thankful to have facilitated this group of intelligent, willing, conscious and self-aware people. You are all beautiful souls. Thank you for being in my life 🙏
...
Keep your channels open and clean so that your energy can flow unhindered! Remember to stay present. 
This is YOUR time! 🙌
...
Thank you for your participation, presence and energy invested in this process!

*Task*
Post to the group an audio or text report sharing your experience of journeying through these 21 days of Abundance program.
I invite you to just go for it and have fun with it.

In the report, please share (or write):

•Your name
•Where you are from
•Yesterday in your journal you answered questions about the results of this journey. Now share your answers here.
...
Perhaps here you will meet like-minded people, partners or people interested in your offerings.

Use all of your creative abilities, describing yourself and your experience. 🤩 And remember that brevity is the soul of wit. ✨

‼You have 48 hours - by Tuesday midnight - to complete this task, to share your report ‼ 
